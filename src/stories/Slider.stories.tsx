      ...
      >
        <Stack spacing={4}>
          <Stack spacing={1}>
            ...
            <Slider valueLabelDisplay="on" defaultValue={50} min={0} max={100} />
            <Slider valueLabelDisplay="auto" defaultValue={50} min={0} max={100} disabled />
          </Stack>

          <Stack spacing={1}>
            <Typography color="grey.300">Primary – Discrete</Typography>
            <Slider valueLabelDisplay="on" defaultValue={50} step={10} marks min={0} max={100} />
            <Slider
