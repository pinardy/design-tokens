  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <MenuList>
          <MenuItem selected={clickState0} onClick={() => Setclick0((prev) => !prev)}>
            Menu Item
          </MenuItem>
          <MenuItem selected={clickState1} onClick={() => Setclick1((prev) => !prev)}>
            Menu Item
          </MenuItem>
          <MenuItem selected={clickState2} onClick={() => Setclick2((prev) => !prev)}>
            Menu Item
          </MenuItem>
